	...
	public static void loadLanguage(int languageID)
	{
		...
		if (languageID == Lang_VI)
		{
			...
			tips = new string[2][]
			{
				new string[14]
				{
					"Bạn có thể nhấn giữ nút chuyển mục tiêu để hiển thị danh sách người chơi khác trong map",
					"Bạn có thể sử dụng cách điều khiển bằng Phím cảm ứng hoặc Analog",
					"Cừu sát sẽ làm tăng 2 điểm hiếu chiến. Đồ sát sẽ làm tăng 1 điểm hiếu chiến",
					"Đối với Kiếm, Kunai, Đao: Nên tăng Sức Mạnh, Thể Lực, Thân pháp",
					"Đối với Cung, Phi Tiêu, Quạt: Nên tăng Chakra, Thể Lực, Thân pháp",
					"Lập tổ đội đi luyện cùng nhau bạn sẽ nhận được nhiều kinh nghiệm hơn và làm nhiệm vụ nhanh hơn",
					"Để giảm hiếu chiến, bạn phải bị người khác đánh trọng thương. Vào đấu trường để thi đấu để giảm",
					"Khi tách đá khỏi trang bị, bạn sẽ thu lại một nửa số đá ép vào lúc đầu",
					"Bạn có thể đổi Xu từ Yên, với điều kiện có đủ điểm hoạt động",
					"Bạn sẽ có phần thưởng nếu đạt thành tích cao nhất trong đấu trường mỗi ngày",
					"Để vào khu vực đấu trường, hãy tìm Rikudou đứng ở mỗi trường",
					"Bạn có thể tăng tỉ lệ thành công khi nâng cấp đồ bằng cách chọn phương pháp Cẩn Thận, nhưng sẽ tốn Lượng",
					"Bạn được tặng 10 lượng khi đạt cấp độ 20 tại NPC Okanechan",
					"Tiền Lượng được chia sẻ cho 3 nhân vật trong 1 tài khoản"
				},
				new string[18]
				{
					...
					"Cừu sát sẽ làm tăng 2 điểm hiếu chiến.",
					" Đồ sát sẽ làm tăng 1 điểm hiếu chiến",
					"Đối với Kiếm, Kunai, Đao: Nên tăng Sức Mạnh, Thể Lực, Thân pháp",
					"Đối với Cung, Phi Tiêu, Quạt: Nên tăng Chakra, Thể Lực, Thân pháp",
					"Lập tổ đội đi luyện cùng nhau bạn sẽ nhận được nhiều kinh nghiệm hơn và làm nhiệm vụ nhanh hơn",
					"Để giảm hiếu chiến, bạn phải bị người khác đánh trọng thương. Vào đấu trường để thi đấu để giảm",
			...
			REGISTER_TEXT = new string[2]
			{
				"Để xác thực với tên",
				"bạn phải đồng ý với quy định của trò chơi."
			};
			...
			CLANPT_MESSAGE = new string[3]
			{
				"Tin nhắn gia tộc, nhóm",
				"Tin nhắn gia tộc",
				"Tin nhắn nhóm"
			};
			PROTECT = "hộ tống";
			...
			UPGRADE_CONDITION = new string[3]
			{
				"Chỉ được chuyển hóa trang bị cùng",
				"loại và cùng cấp trở lên.",
				"Sẽ khóa trang bị sau khi chuyển hóa."
			};
			...
			TITLECLOTHE = new string[2]
			{
				"Tiệm Y Phục",
				"Hành trang"
			};
			TITLENON = new string[2]
			{
				"Nón",
				"Hành trang"
			};
			TITLEAO = new string[2]
			{
				"Áo",
				"Hành trang"
			};
			TITLEGANGTAY = new string[2]
			{
				"Găng tay",
				"Hành trang"
			};
			TITLEQUAN = new string[2]
			{
				"Quần",
				"Hành trang"
			};
			TITLEGIAY = new string[2]
			{
				"Giày",
				"Hành trang"
			};
			TITLEDAYCHUYEN = new string[2]
			{
				"Dây chuyền",
				"Hành trang"
			};
			TITLENHAN = new string[2]
			{
				"Nhẫn",
				"Hành trang"
			};
			TITLENGOCBOI = new string[2]
			{
				"Ngọc bội",
				"Hành trang"
			};
			TITLEPHU = new string[2]
			{
				"Bùa",
				"Hành trang"
			};
			TITLEWEAPON = new string[2]
			{
				"Binh khí",
				"Hành trang"
			};
			TITLESTACK = new string[2]
			{
				"Dược phẩm",
				"Hành trang"
			};
			TITLESTACKLOCK = new string[2]
			{
				"Dược phẩm",
				"Hành trang"
			};
			TITLEGROCERY = new string[2]
			{
				"Thức ăn",
				"Hành trang"
			};
			TITLEGROCERYLOCK = new string[2]
			{
				"Thức ăn",
				"Hành trang"
			};
			TITLEUPGRADE = new string[2]
			{
				"Nâng cấp",
				"Hành trang"
			};
			TITLESTAND = new string[2]
			{
				"Gian hàng",
				"Hành trang"
			};
			TITLECONVERT = new string[2]
			{
				"Chuyển hóa",
				"Hành trang"
			};
			TITLEUPPEARL = new string[2]
			{
				"Luyện đá",
				"Hành trang"
			};
			...
			TITLEELITESHOP = new string[1]
			{
				"Bảo vật"
			};
			TITLECLANSTORE = new string[1]
			{
				"Cửa hàng gia tộc"
			};
			TITLESPLIT = new string[2]
			{
				"Tách Đá",
				"Hành trang"
			};
			TITLETRADE = new string[2]
			{
				"Giao dịch",
				"Hành trang"
			};
			TITLELUYENTHACH = new string[2]
			{
				"Luyện thạch",
				"Hành trang"
			};
			TITLELUYENTHU = new string[2]
			{
				"Dịch chuyển",
				"Hành trang"
			};
			TITLELUYENAO = new string[2]
			{
				"Tinh luyện",
				"Hành trang"
			};
			TITLEKHAMNGOC = new string[2]
			{
				"Khảm ngọc",
				"Hành trang"
			};
			TITLELUYENNGOC = new string[2]
			{
				"Luyện ngọc",
				"Hành trang"
			};
			TITLEGOTNGOC = new string[2]
			{
				"Gọt ngọc",
				"Hành trang"
			};
			TITLEGIAODO = new string[2]
			{
				"Giao đồ",
				"Hành trang"
			};
			TITLETHAONGOC = new string[2]
			{
				"Tháo ngọc",
				"Hành trang"
			};
			...
			HELPCRYSTAL = new string[3]
			{
				"- Sử dụng Yên, nếu không đủ dùng Xu",
				"- Qua trang Hành Trang để chọn Đá",
				"- Số lượng đá từ 2 đến 24"
			};
			HELPUPGRADE = new string[4]
			{
				"- Sử dụng Yên, nếu không đủ dùng Xu",
				"- Nâng cấp cẩn thận cần dùng lượng",
				"- Chỉ chọn Trang Bị và Đá",
				"Trang bị đã được nâng cấp tối đa"
			};
			HELPSPLIT = new string[3]
			{
				"- Qua Hành Trang để chọn Trang Bị",
				" Sau khi tách xong sẽ như lúc đầu",
				"Trang bị đã được tách"
			};
			HELPKHAMNGOC = new string[2]
			{
				"- Sử dụng Yên, nếu không đủ dùng Xu",
				"- Chỉ chọn Trang Bị và Ngọc"
			};
			LOCK1 = "Khóa G.Dịch";
			...
			NOPOINT = new string[2]
			{
				"Bạn đã hết điểm kỹ năng. Vui lòng đánh lên level để có thêm điểm kỹ năng",
				"Bạn đã hết điểm tiềm năng. Vui lòng đánh lên level để có thêm điểm tiềm năng"
			};
			...
			inforMePoint = new string[20]
			{
				...
				"Danh vọng quần: ",
				"Danh vọng giày: ",
				"Hoàn thành NV mỗi ngày: ",
				"Truy bắt Tà Thú còn: ",
				"Học sách tiềm năng sơ: ",
				"Học sách kỹ năng sơ: ",
				"Gia tộc: ",
				"Vào hang động còn: ",
				"Điểm tinh tú: ",
				"Số lần ăn bánh phong lôi: ",
				"Số lần ăn bánh băng hỏa: "
			};
			ERRONUMBER = "Có lỗi xảy ra. Xin vui lòng chỉ nhập số";
			MENUNEWCHAR = new string[3]
			{
				"Tên: ",
				"Giới tính: ",
				"Tóc: "
			};
			MENUGENDER = new string[2]
			{
				"Nữ",
				"Nam"
			};
			...
			TYPEUPPEARL = new string[2]
			{
				"Luyện đá thành công",
				"Luyện đá thất bại"
			};
			TYPEUPGRADE = new string[4]
			{
				"Thành công, trang bị được lên cấp ",
				"Thất bại, trang bị trở về cấp ",
				"Trang bị được nâng cấp tối đa",
				"Trang bị cấp"
			};
			TYPEKHAMNGOC = new string[2]
			{
				"Khảm ngọc thành công",
				"Khảm ngọc thất bại"
			};
			MONTH = "tháng";
			WEEK = "tuần";
			...
			CLANINFO = new string[13]
			{
				...
				"Phí duy trì: ",
				"Phí nâng cấp: ",
				"Vào Lãnh Địa Gia Tộc: còn ",
				"Cống hiến tuần: ",
				"Sử dụng lệnh bài còn: "
			};
			CLAN_ACTIVITY = new string[7]
			{
				"xu lúc",
				"Thành lập gia tộc, ngân sách nhận",
				"bị trục xuất, ngân sách trừ",
				"đóng góp quỹ gia tộc, ngân sách tăng",
				"rút quỹ gia tộc, ngân sách giảm",
				"Thu phí duy trì gia tộc, ngân sách giảm",
				"nâng cấp gia tộc, ngân sách giảm"
			};
			...
			CLAN_MENU = new string[9]
			{
				...
				"Nâng Cấp",
				"Mời vào lãnh địa",
				"Mời vào Gia tộc chiến",
				"Khai mở"
			};
			CLAN_SORTTYPE = "SX theo C.Hiến tuần";
			TEAMLEADER_SELECT = new string[3]
			{
				"Trục xuất",
				"Nhường",
				"Kết bạn"
			};
			CLANLEADER_SELECT = new string[2]
			{
				"Tộc phó",
				"Trưởng lão"
			};
			...
			HELPPOTENTIAL1 = new string[1]
			{
				"Bạn phải vào trường để tăng điểm"
			};
			HELPPOTENTIAL2 = new string[4]
			{
				"Sức mạnh = Tấn công",
				"Thân pháp = né,chính xác",
				"Thể lực = HP",
				"Chakra = MP"
			};
			HELPPOTENTIAL3 = new string[4]
			{
				"Không cần tăng sức mạnh",
				"Thân pháp = né,chính xác",
				"Thể lực = HP",
				"Chakra = Tấn công, MP"
			};
			HELPPOTENTIAL4 = new string[4]
			{
				"Sức mạnh = 10 tấn công",
				"Nhanh nhẹn = 10 chính xác",
				"Sức khỏe = 10s triệu hồi",
				"Trí tuệ = 1 MP"
			};
			CLOSE_CURTAB = "Đóng tab hiện tại";
			PUBLICCHAT = new string[2]
			{
				"Công cộng",
				"Bạn có thể chat với người đứng gần tại đây"
			};
			PARTYCHAT = new string[2]
			{
				"Chung nhóm",
				"Bạn có thể chat với người trong cùng nhóm tại đây"
			};
			GLOBALCHAT = new string[4]
			{
				"Kênh thế giới",
				"Bạn mất 5 lượng mỗi lần chat kênh thế giới.",
				"Tất cả người đang online đều thấy bạn chat.",
				"Bạn sẽ bị khóa tài khoản nếu chửi bậy, quảng cáo wap web trên kênh thế giới."
			};
			CLANCHAT = new string[2]
			{
				"Gia tộc",
				"Bạn có thể chat với người trong gia tộc tại đây"
			};
			...
			CLAN_ITEM = new string[5][]
			{
				new string[2]
				{
					"Yêu cầu: gia tộc đạt cấp 5.",
					"Phí khai mở: 1.000.000 xu gia tộc."
				},
				new string[2]
				{
					"Yêu cầu: gia tộc đạt cấp 10.",
					"Phí khai mở: 5.000.000 xu gia tộc."
				},
				new string[2]
				{
					"Yêu cầu: gia tộc đạt cấp 15.",
					"Phí khai mở: 10.000.000 xu gia tộc."
				},
				new string[2]
				{
					"Yêu cầu: gia tộc đạt cấp 20.",
					"Phí khai mở: 20.000.000 xu gia tộc."
				},
				new string[2]
				{
					"Yêu cầu: gia tộc đạt cấp 25.",
					"Phí khai mở: 30.000.000 xu gia tộc."
				}
			};
			AUTO_TEXT = new string[8]
			{
				"Dùng HP khi còn dưới: ",
				"Dùng MP khi còn dưới:",
				"Dùng thức ăn cấp: ",
				"Dùng chiêu hổ trợ",
				"Nhặt yên",
				"Nhặt Yên và HP,MP",
				"Nhặt Yên, HP, MP và N.Liệu",
				"Không nhặt gì cả"
			};
			...
			LUYEN_THACH = new string[3]
			{
				"Luyện thạch cấp cao hơn bằng cách",
				"dùng 9 thạch cùng loại hoặc 3 thạch sơ",
				"và đá 11 hoặc 3 thạch trung và đá 12."
			};
		...
		else
		{
			...
			tips = new string[2][]
			{
				new string[14]
				{
					"Press change focus button to show all players on map",
					"For keyboard phones, assign shortcut keys 7,8,9 (or Q,W,E) to use skills.",
					"Berserk mode adds +2 agressive points.  Kill adds +1 agressive",
					"Sword, Kunai,and Blade increases Strength, Constitution, Dexterity",
					"Bow, Shuriken and Fan increases Chakra, Constitution, Dexterity",
					"Training as a team will earn experience and complete tasks faster",
					"Fighing other players on the battlefield will decrease combative points.",
					"When separated from the stone equipped, you will collect half amount of stone at the beginning.",
					"If you have enough action points, you can exchange coins from kin.",
					"The highest daily achievement in the arena will earn a reward.",
					"Find Rikudou to get into the arena.",
					"Precautionary measures cost money but will Increase the success rate of upgrading items",
					"When you reach Level 20, find Okanechan to received 10 gold bars.",
					"Gold bars will be split to 3 characters in 1 account"
				},
				new string[17]
				{
					"Use the key Q , W, E, A, D to move character",
					"Or you can use key Up, Left, Right to move char",
					"Key Spacerbar or Enter for attack or actions",
					"Key F1 : Menu, key F2: change focus, key 6,7 use HP,MP ",
					"key 0: Chat,key P: Change other skills, Key 1,2,3,4,5: use for skill  which is assigned in the skill's menu",
					"Berserket mode will increase 2 points of agressive. Kill just increase 1 point of agressive",
					"With Sword, Kunai, Blade: Should increase Strength, Constitution, Dexterity",
					"With Bow, Shuriken, Fan: Should increase Chakra, Constitution, Dexterity",
					"Make a team to train together, you will get more experienced and faster task",
					"To decrease combative point, you have to be fought by other players on the battlefield.",
					"When separated from the stone equipped, you will collect half amount of stone at the beginning.",
					"You can change the coins from kin incase you have enough action point.",
					"You will have a reward if you reach the highest achievement in the fight arena this day",
					"To get into the fight arena, look Rikudou stand in each school to check in to.",
					"You can increase the success rate when upgrading items by selecting a precautionary measure, but would cost amoun",
					"You will have 10 gold bars when you reach level 20, come to see NPC Okanechan",
					"Gold bars will be split to 3 characters in 1 account"
				}
			};
			...
			REGISTER_TEXT = new string[2]
			{
				"To register with name",
				"you have to follow the game rule."
			};
			...
			UPGRADE_CONDITION = new string[3]
			{
				"Just transfer same type equipment",
				" or higher.",
				"Will lock fitted after transformation.."
			};
			...
			HELPCRYSTAL = new string[3]
			{
				"- Use kin incase not enough coin",
				"- Move to inventory to choose stone",
				"- Amount of stones from 2 to 24"
			};
			HELPUPGRADE = new string[4]
			{
				"- Use coin incase not enough kin",
				"- Upgrading need Gold bar",
				"- Choose Equiptment and stone only",
				"Your equipment has reached max level"
			};
			HELPSPLIT = new string[3]
			{
				"- Move to inventory to choose Equipment",
				" After separation will be back to begining form",
				"Separation successfull"
			};
			HELPKHAMNGOC = new string[2]
			{
				"- Use coin incase not enough kin",
				"- Choose Equiptment and Gem"
			};
			LOCK1 = "Lock Transfer";
			...
			NOPOINT = new string[2]
			{
				"You are run out off skill points. Upgrade your level for more skill points.",
				"You are run out off potential points. Upgrade your level for more potential points. "
			};
			inforMe = new string[20]
			{
				"Character: ",
			...
			inforMePoint = new string[20]
			{
				...
				"Pants Fame: ",
				"Shoes Fame: ",
				"Accomplish daily quest: ",
				"Arrest Beast: ",
				"Read the basic potential book: ",
				"Read the basic skill book: ",
				"Clan: ",
				"Cave time left: ",
				"Star Fame: ",
				"Wind Thunder Mooncake: ",
				"Ice Fire Mooncake: "
			};
			...
			TYPEUPGRADE = new string[4]
			{
				"Success,  equipped with level up ",
				"failed, return level of equipment",
				"equipment upgraded maximum",
				"equipment level"
			};
			TYPEKHAMNGOC = new string[2]
			{
				"Success socketing",
				"Socketing has failed"
			};
			MONTH = "month";
			WEEK = "week";
			DAY = "day";
			...
			CLANINFO = new string[13]
			{
				...
				"Maintenance fee: ",
				"Upgrade fee: ",
				"Enter the Territory of Clan: remain ",
				"Week donation: ",
				"Use Clan card mark: remain "
			};
			CLAN_ACTIVITY = new string[7]
			{
				"Coins at",
				"Establish clan, budget has",
				"expulsion, budget decrease",
				"clan contribution, budget increase",
				"withdraw clan budget, budget decrease",
				"Fee for maintain clan, budget decrease",
				"upgrade clan, budget decrease"
			};
			...
			DES_TASK = new string[4]
			{
				...
				" at ",
				" to get the quest.",
				"You have finished all quests this version, please wait for the next version."
			};
			DIES = new string[4]
			{
				"Exhausted",
			...
			HELPPOTENTIAL1 = new string[1]
			{
				"Go to school to upgrade your marks."
			};
			HELPPOTENTIAL2 = new string[4]
			{
				"Strength = Attack",
				"Dexterity = dodge, accurate",
				"Strength = HP",
				"Chakra = MP"
			};
			HELPPOTENTIAL3 = new string[4]
			{
				"No need to upgrade strength",
				"Dexterity = dodge, accurate",
				"Strength = HP",
				"Chakra = Attack, MP"
			};
			...
			{
				"Public chat",
				"You can chat with people around you here."
			};
			PARTYCHAT = new string[2]
			{
				"Same party",
				"You can chat with your Party member here."
			};
			GLOBALCHAT = new string[4]
			{
				"Global chat",
				"You will lose 5 Gold Bars for each use.",
				"This message will broadcast to everybody.",
				"Your account will automatically be locked if you attempt to advestise any wap website, or use profanity."
			};
			CLANCHAT = new string[2]
			{
				"Clan",
				"Yon can chat with Clanmates in this place"
			};
			...
			CLAN_ITEM = new string[5][]
			{
				new string[2]
				{
					"Requirement: Clan level 5",
					"Cost to Open: 1.000.000 clan coins."
				},
				new string[2]
				{
					"Requirement: Clan level 10.",
					"Cost to Open: 5.000.000 clan coins."
				},
				new string[2]
				{
					"Requirement: Clan level 15.",
					"Cost to Open: 10.000.000 clan coins."
				},
				new string[2]
				{
					"Requirement: Clan level 20.",
					"Cost to Open: 20.000.000 clan coins."
				},
				new string[2]
				{
					"Requirement: Clan level 25.",
					"Cost to Open: 30.000.000 clan coins."
				}
			};
			AUTO_TEXT = new string[8]
			{
				...
				"MP: ",
				"Using food level: ",
				"Always using skill to support",
				"Pick up Kins",
				"Pick up Kins and Hp, MP",
				"Pick up Kins, Hp, Mp and Material",
				"Not picked up"
			};
			...
			LUYEN_THACH = new string[3]
			{
				"Upgrade essence by using 9 essences",
				"of the same kind or 3 common essences",
				"and stone level 11 or 3 rare essences and stone level 12."
			};
