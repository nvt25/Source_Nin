...
public class Char : MainObject
{
	...
	public short[] idpartThoitrang = new short[4]
	{
		-1,
		-1,
		-1,
	...
	public short[] fRun_PP = new short[10]
	{
		2,
		2,
		3,
	...
	public void updateFrameSuSan()
	{
		...
		DataSkillEff partEff = getPartEff(ID_SUSANO, ishorse: false);
	...
	public int[] getClassCoat()
	{
		...
		case -1:
			return null;
		case 420:
			result = ((!isWolf && !isMoto && !isNewMount) ? new int[4]
			{
				1635,
				1636,
				1637,
	...
	private void paintCharWithoutSkill(mGraphics g)
	{
		try
		{
			...
			DataSkillEff partEff4 = getPartEff(ID_SUSANO, ishorse: false);
			DataSkillEff partEff5 = getPartEff(ID_RANK, ishorse: false);
			DataSkillEff partEff6 = getPartEff(ID_NAME, ishorse: false);
			DataSkillEff partEff7 = getPartEff(ID_LEG, ishorse: false);
			...
			DataSkillEff partEff8 = getPartEff(ID_HORSE, ishorse: true);
			...
			DataSkillEff partEff9 = getPartEff(ID_Body, ishorse: false);
			...
			DataSkillEff partEff10 = getPartEff(ID_HAIR, ishorse: false);
			...
			DataSkillEff partEff11 = getPartEff(ID_PP, ishorse: false);
